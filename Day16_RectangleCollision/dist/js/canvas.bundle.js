...
function animate() {
  ...
  var staticRectangleX = canvas.width / 2 - 50;
  var staticRectangleY = canvas.height / 2 - 50;
  var touched = false;
  rect2x = mouse.x - 50;
  rect2y = mouse.y - 50;

  if (mouse.x - 50 + 100 > staticRectangleX && mouse.x - 50 < staticRectangleX + 100 && mouse.y - 50 + 100 > staticRectangleY && mouse.y - 50 < staticRectangleY + 100) {
    console.log('touched');
    touched = true;
  }
